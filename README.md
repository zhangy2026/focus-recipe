...
一个**单文件 HTML** 番茄时钟：68KB、零依赖、零后端、离线可用，数据只存在你自己的浏览器里。

- 🌐 在线体验（内地推荐）：https://8f84cc8a29094870b7c293a19839b873.app.workbuddy.link
- 🏠 GitHub Pages（海外推荐）：https://zhangy2026.github.io/focus-recipe/
...
- 🎯 5 种内置配方：深度 50′ / 学习 25′ / 事务 15′ / 碎片 10′ / 会议正计时，四项时长均可改
- 🏷 自建任务类别：最多再加 5 个，名称 / 配色 / 时长随你定，统计与分享卡片同步生效
- ✂️ 打断记录：切断次数成为可分析的数据，而非惩罚
- 📝 完成收尾：写一句「下一步」，下次启动直接看到
- 📊 数据面板：KPI、分类分布、12 周热力图、洞察与时长建议
- 🖼 分享卡片：一键生成 PNG 战绩卡
- 📲 扫码分享：生成二维码，手机扫一下直接打开
